...
import { z } from 'zod';
import { CreateRoomData } from '@/lib/api';
import {
  Dialog,
  DialogContent,
  DialogDescription,
...
interface AddRoomDialogProps {
  ...
  onAddRoom: (room: CreateRoomData) => void;
...
export function AddRoomDialog({
  ...
  const onSubmit = async (data: RoomFormData) => {
    ...
    if (existingRoomNumbers.includes(data.roomNumber.toUpperCase())) {
      setError('roomNumber', {
        type: 'manual',
    ...
    <Dialog open={open} onOpenChange={handleClose}>
      <DialogContent className="sm:max-w-[900px] max-h-[90vh] overflow-y-auto mx-4 sm:mx-auto">
        <DialogHeader>
          ...
          <DialogDescription>
            Add a new room to your property. New rooms are created as vacant.
          </DialogDescription>
        </DialogHeader>
            ...
            <div className="space-y-4">
              ...
              <div className="rounded-xl bg-muted/50 p-4 border border-border">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="font-medium text-foreground">New Room</p>
                    <p className="text-xs text-muted-foreground">Status: Vacant • {images.length} image(s)</p>
                  </div>
                </div>
              </div>
            </div>
